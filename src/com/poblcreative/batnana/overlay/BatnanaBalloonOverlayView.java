...
public class BatnanaBalloonOverlayView<Item extends BatnanaOverlayItem> extends
        BalloonOverlayView<Item>
{
    ...
    public BatnanaBalloonOverlayView(Context context, int balloonBottomOffset)
    {
        ...
        int heightPx = (int) (TypedValue.applyDimension(
                TypedValue.COMPLEX_UNIT_DIP, heightDip, context.getResources()
                        .getDisplayMetrics()) + 0.5f);
        int widthPx = (int) (TypedValue.applyDimension(
                TypedValue.COMPLEX_UNIT_DIP, widthDip, context.getResources()
                        .getDisplayMetrics()) + 0.5f);

        // Log.i(this.toString(), widthDip + "dips wide is " + widthPx + "px, "
        // + heightDip + "dips high is " + heightPx + "px");
